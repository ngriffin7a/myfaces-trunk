...
public class ValueBindingTest extends ELBaseTest
{
    ...
    {
        Object v;
        v = _application.createValueBinding("#{theA.name}").getValue(
            _facesContext);
    ...
    {
        Object v;
        v = _application.createValueBinding("#{theA.theB.name}").getValue(
            _facesContext);
    ...
    {
        Object v;
        v = _application.createValueBinding("#{theA.theB.theC.name}").getValue(
            _facesContext);
    ...
    {
        Object v;
        v = _application.createValueBinding("#{a.name}")
            .getValue(_facesContext);
        assertEquals(A.NAME, v);
    }
    ...
    {
        Object v;
        v = _application.createValueBinding("#{a.b.name}").getValue(
            _facesContext);
        assertEquals(B.NAME, v);
    }
    ...
    {
        Object v;
        v = _application.createValueBinding("#{a.b.c.name}").getValue(
            _facesContext);
        assertEquals(C.DEFAULT_NAME, v);
    }
    ...
    public void testGetValue() throws Exception
    {
        ...
        vb = _application
            .createValueBinding("#{ testmap [ \"o\" ] [ 'obj' ] }");
        r = vb.getValue(_facesContext);
        assertEquals("OBJECT", r);
        ...
        vb = _application
            .createValueBinding("#{ testmap   [ testmap   . t ] }");
        r = vb.getValue(_facesContext);
        assertEquals("TRUE", r);
        ...
        vb = _application
            .createValueBinding("#{testmap.list[4].list[1][0][0]}");
        r = vb.getValue(_facesContext);
        assertEquals(new Integer(0), r);

        vb = _application
            .createValueBinding("#{testmap.map.map.list[4].list[4][1][0][0]}");
        r = vb.getValue(_facesContext);
        assertEquals(new Integer(0), r);

        vb = _application
            .createValueBinding("#{testmap.map.list[4].map.list[4][1][0][0]}");
        r = vb.getValue(_facesContext);
        assertEquals(new Integer(0), r);

        vb = _application
            .createValueBinding("#{testmap.list[4][testmap.list[4][0][0]][0]}");
        r = vb.getValue(_facesContext);
        assertEquals(new Integer(0), r);

        vb = _application
            .createValueBinding("#{testmap.list[4][1][0][testmap.list[4][0][0]]}");
        r = vb.getValue(_facesContext);
        assertEquals(new Integer(0), r);

        vb = _application
            .createValueBinding("#{testmap.list[4].list[testmap.list[4][1][0][testmap.list[4][0][1]]][0][0]}");
        r = vb.getValue(_facesContext);
        assertEquals(new Integer(0), r);

        vb = _application
            .createValueBinding("#{testmap.map.map.list[4].list[4][1][testmap.list[4].list[testmap.list[4][1][0][testmap.list[4][0][testmap.t]]][0][0]][0]}");
        r = vb.getValue(_facesContext);
        assertEquals(new Integer(0), r);

        vb = _application
            .createValueBinding("#{testmap['my]bracket[']['map'].list[4]['map'][\"list\"][4][1][testmap.map.map.list[4].list[4][1][testmap.list[4].list[testmap.list[4][1][testmap.f][testmap['list'][4][0][1]]][0][0]][0]][0]}");
        r = vb.getValue(_facesContext);
        assertEquals(new Integer(0), r);
        ...
        {
            vb = _application
                .createValueBinding("#{testmap.map.list[4].map.list[][1][0][0]}");
            assertTrue(false);
        }
        catch (ReferenceSyntaxException e)
        {
    ...
    public void testMixedExpressions()
    {
        ...
        vb = _application
            .createValueBinding("This is one #{testmap[\"o\"]['obj']}");
        r = vb.getValue(_facesContext);
        assertEquals("This is one OBJECT", r);

        vb = _application
            .createValueBinding("#{ testmap [ \"o\" ] [ 'obj' ] } is the One.");
        r = vb.getValue(_facesContext);
        ...
        vb = _application
            .createValueBinding("#{testmap . true_} or #{testmap.false_}, that's the question!");
        r = vb.getValue(_facesContext);
        assertEquals("TRUE_ or FALSE_, that's the question!", r);

        vb = _application
            .createValueBinding("What? #{testmap . true_} or #{testmap.false_}, that's the question!");
        r = vb.getValue(_facesContext);
        ...
        vb = _application
            .createValueBinding("#{ '#{' } What? ${ #{true ? '${' : \"#{\\\\\"} #{testmap . true_} or #{testmap.false_}, that's the question! }");
        r = vb.getValue(_facesContext);
    ...
    public void testIsReadOnly() throws Exception
    {
        ...
        vb = _application.createValueBinding("#{nonExistentValueBlahBlahBlah}");
        assertFalse(vb.isReadOnly(_facesContext));

        vb = _application
            .createValueBinding("#{nonExistingValueBlahBlahBlah.blah}");
        assertFalse(vb.isReadOnly(_facesContext));

        vb = _application
            .createValueBinding("#{nonExistingValueBlahBlahBlah.blah.blah}");
        assertFalse(vb.isReadOnly(_facesContext));
    }
    ...
    public void testGetType() throws Exception
    {
        ...
        vb = _application
            .createValueBinding("#{applicationScope.bean == null}");
        assertSame(Boolean.class, vb.getType(_facesContext));
        ...
        vb = _application
            .createValueBinding("#{nonExistingValueBlahBlahBlah.blah}");
        assertSame(null, vb.getType(_facesContext));
    ...
    public void testManagedBean() throws Exception
    {
        ...
        assertFalse("false", Boolean.getBoolean(vb.getValue(_facesContext)
            .toString()));
    ...
    public void testEL() throws Exception
    {
        ...
        vb = _application
            .createValueBinding("#{facesContext.application.defaultRenderKitId}");
