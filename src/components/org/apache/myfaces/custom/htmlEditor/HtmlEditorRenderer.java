        ...
        writer.writeAttribute(HTML.STYLE_ATTR, "display: none;",null);
        	...
        	writer.writeAttribute("id", "kupuconfig", null);
        		...
        		writer.startElement("kupuconfig", null);
					...
					writeTag(writer, "image_xsl_uri", AddResource.getResourceMappedPath(HtmlEditorRenderer.class, "kupudrawers/imagedrawer.xsl", context));
					writeTag(writer, "link_xsl_uri", AddResource.getResourceMappedPath(HtmlEditorRenderer.class, "kupudrawers/linkdrawer.xsl", context));
					
					// TODO : Make this work (reference available images, ...).
					writeTag(writer, "image_libraries_uri", AddResource.getResourceMappedPath(HtmlEditorRenderer.class, "kupudrawers/demolibraries.xml", context));
					writeTag(writer, "link_libraries_uri", AddResource.getResourceMappedPath(HtmlEditorRenderer.class, "kupudrawers/demolibraries.xml", context));
        ...
        writer.writeAttribute(HTML.CLASS_ATTR, "kupu-fulleditor", null);
			...
			writer.writeAttribute(HTML.ID_ATTR, "toolbar",null);
    			...
    			writer.writeAttribute(HTML.STYLE_ATTR,
    				...
    				writer.writeAttribute(HTML.TITLE_ATTR, "Kupu 1.1",null);
            	...
            	writer.writeAttribute(HTML.CLASS_ATTR, "kupu-tb-buttongroup", null);
            		...
            		writeButton(writer, "kupu-table", "Insert table", null, "kupu-tabledrawer-button");
            	writer.endElement(HTML.SPAN_ELEM);
             		...
             		writer.writeAttribute(HTML.WIDTH_ATTR, "100%",null);
             			writer.startElement(HTML.TBODY_ELEM,null);
             				...
             				writer.startElement(HTML.TR_ELEM,null);
             					...
             					writer.startElement(HTML.TD_ELEM,null);
             					writer.writeAttribute(HTML.WIDTH_ATTR, "1%", null);
             						writer.startElement(HTML.SELECT_ELEM,null);
                 						...
                 						writer.writeAttribute(HTML.WIDTH_ATTR, "100%", null);
                         					...
                         					writer.startElement(HTML.TR_ELEM,null);
	                         					...
	                         					writer.startElement(HTML.TD_ELEM,null);
	                         						writer.startElement(HTML.BUTTON_ELEM, null);
	                         						writer.writeAttribute(HTML.TYPE_ATTR, "button", null);
	                         						writer.writeAttribute(HTML.ID_ATTR, "kupu-table-addcolumn-button", null);
	                         						writer.writeAttribute(HTML.ONCLICK_ATTR, "drawertool.current_drawer.tool.addTableColumn", null);
	                         							writer.write("Add");
	                         						writer.endElement(HTML.BUTTON_ELEM);
	                         						writer.startElement(HTML.BUTTON_ELEM, null);
	                         						writer.writeAttribute(HTML.TYPE_ATTR, "button", null);
	                         						writer.writeAttribute(HTML.ID_ATTR, "kupu-table-delcolumn-button", null);
                         					...
                         					writer.startElement(HTML.TR_ELEM,null);
	                         					...
	                         					writer.startElement(HTML.TD_ELEM,null);
	                         						writer.startElement(HTML.BUTTON_ELEM, null);
	                         						writer.writeAttribute(HTML.TYPE_ATTR, "button", null);
	                         						writer.writeAttribute(HTML.ID_ATTR, "kupu-table-addrow-button", null);
	                         						writer.writeAttribute(HTML.ONCLICK_ATTR, "drawertool.current_drawer.addTableRow", null);
	                         							writer.write("Add");
	                         						writer.endElement(HTML.BUTTON_ELEM);
	                         						writer.startElement(HTML.BUTTON_ELEM, null);
	                         						writer.writeAttribute(HTML.TYPE_ATTR, "button", null);
	                         						writer.writeAttribute(HTML.ID_ATTR, "kupu-table-delrow-button", null);
        	...
        	if( ! editor.isShowAnyToolBox() ){
            	...
            	if( ! editor.isShowPropertiesToolBox() ){
            		...
            		writer.startElement(HTML.TEXTAREA_ELEM, null);
            			writer.writeAttribute(HTML.STYLE_ATTR, "width: 90%", null);
            	...
            	if( ! editor.isShowLinksToolBox() ){
            		...
            		writer.writeAttribute(HTML.CLASS_ATTR, "kupu-toolbox-addlink", null);
	            		...
	            		writer.writeAttribute(HTML.CLASS_ATTR, "kupu-toolbox-st", null);
	            		writer.writeAttribute(HTML.TYPE_ATTR, "text", null);
	            		writer.writeAttribute(HTML.STYLE_ATTR, "width: 98%", null);
	            		writer.endElement(HTML.INPUT_ELEM);
            	...
            	if( ! editor.isShowImagesToolBox() ){
            		...
            		writer.startElement(HTML.DIV_ELEM, null);
            		writer.writeAttribute(HTML.CLASS_ATTR, "kupu-toolbox-images", null);
            	...
            	if( ! editor.isShowDebugToolBox() ){
            		...
            		writer.writeAttribute(HTML.CLASS_ATTR, "kupu-toolbox-label", null);
            		writer.writeAttribute(HTML.STYLE_ATTR, "height: 150px;", null);
            		writer.endElement(HTML.DIV_ELEM);
            	writer.endElement(HTML.DIV_ELEM);
