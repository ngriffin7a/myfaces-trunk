 ...
 */
public class CbpViewHandlerImpl extends ViewHandler {

	private static Log log = LogFactory.getLog(CbpViewHandlerImpl.class);
...
//		return null;
	...
	public UIViewRoot createView(FacesContext ctx, String viewId) {
		...
		ctx.getExternalContext().getSessionMap().put(net.sourceforge.myfaces.application.cbp.CbpStateManagerImpl.SESSION_KEY_CURRENT_VIEW,ret);
