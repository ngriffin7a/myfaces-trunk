...
<x:panelNavigation id="nav"
    ...
    <x:commandNavigation id="nav_2" value="#{example_messages['nav_Examples']}" >
        ...
        <x:commandNavigation id="nav_2_4" value="#{example_messages['nav_Components']}" >
            ...
            <x:commandNavigation id="nav_2_4_9" value="#{example_messages['nav_rssTicker']}" action="go_rssticker" />
            <x:commandNavigation id="nav_2_4_10" value="#{example_messages['nav_dataScroller']}" action="go_datascroller" />
        </x:commandNavigation>
    </x:commandNavigation>
