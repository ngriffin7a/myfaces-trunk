...
<x:navigation id="nav">
    ...
    <x:navigation_item id="nav-2" label="Examples" >
        ...
        <x:navigation_item id="nav-2-4" label="Simple Jsp-lists" treeId="/example/simpleJspList.jsf"/>
        <x:navigation_item id="nav-2-5" label="Simple sortable list" treeId="/example/simpleSortList.jsf"/>
    </x:navigation_item>
